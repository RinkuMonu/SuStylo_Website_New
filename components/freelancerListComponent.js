...
//                         </span>
//                     )}
//                     {(activeFilters.area || activeFilters.service || activeFilters.minPrice || activeFilters.location) && (
//                         <button
...
//                 {/* Area Filter Button with Dropdown */}
//                 {/* <div className="relative">
//                     <button
//                         onClick={() => {
//                             setIsAtHomeModalOpen(!isAtHomeModalOpen);
...
//                             <div className="p-2">
//                                 <button
//                                     onClick={() => applyFilter('area', 'Malviya Nagar')}
//                                     className="w-full text-left p-2 hover:bg-gray-100 rounded-md text-sm"
//                                 >
//                                     Malviya Nagar
//                                 </button>
//                                 <button
//                                     onClick={() => applyFilter('area', 'Sector 17')}
//                                     className="w-full text-left p-2 hover:bg-gray-100 rounded-md text-sm"
//                                 >
//                                     Sector 17
//                                 </button>
//                                 <button
//                                     onClick={() => applyFilter('area', 'MG Road')}
//                                     className="w-full text-left p-2 hover:bg-gray-100 rounded-md text-sm"
//                                 >
//                                     MG Road
//                                 </button>
//                                 <button
//                                     onClick={() => {
//                                         const areaInput = prompt("Enter area name:");
//                                         if (areaInput) applyFilter('area', areaInput);
//                                     }}
//                                     className="w-full text-left p-2 hover:bg-gray-100 rounded-md text-sm text-blue-600"
//                                 >
//                                     Other Area...
//                                 </button>
//                             </div>
