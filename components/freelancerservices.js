...
export default function FreelancerServicesSection({ serviceData, freelancer_id }) {
    ...
    const handlePaymentSelection = (type) => {
        ...
        if (isUserAuthenticated) {
            ...
            try {
                ...
                toast.error("Session expired or token is invalid. Please log in again.");
    ...
    const createBookingAPI = async (paymentType, freelancerId, userId, userType) => {
        ...
        try {
            ...
            toast.error(`Could not complete booking. ${errorMessage}`);
    ...
    return (
        <>
            ...
            <section id="servicesection" className="bg-[#f6efe4] py-10">
