...
//                     alt="Contact Banner"
//                     fill
//                     className="object-cover object-[center_70%]" // focuses on lower part of image
//                     priority
//                 />

//                 {/* Overlay */}
//                 <div className="absolute inset-0 bg-black/40 flex flex-col items-center justify-center text-center">
//                     {/* Title with your custom multi-layer shadow */}
//                     <h1
...
//                                     className={`border rounded-[10px] p-2 w-full bg-transparent focus:outline-none focus:ring-1 ${errors.fullName ? "border-red-500 focus:ring-red-400" : "border-gray-300 focus:ring-gray-400"
//                                         }`}
//                                 />
//                                 {errors.fullName && (
...
//                                     onChange={handleChange}
//                                     className={`border rounded-[10px] p-2 w-full bg-transparent focus:outline-none focus:ring-1 ${errors.email ? "border-red-500 focus:ring-red-400" : "border-gray-300 focus:ring-gray-400"
//                                         }`}
//                                 />
//                                 {errors.email && (
...
//                                     onChange={handleChange}
//                                     className={`border rounded-[10px] p-2 w-full bg-transparent focus:outline-none focus:ring-1 ${errors.phone ? "border-red-500 focus:ring-red-400" : "border-gray-300 focus:ring-gray-400"
//                                         }`}
//                                 />
//                                 {errors.phone && (
...
//                                     onChange={handleChange}
//                                     className={`border rounded-[10px] p-2 w-full bg-transparent focus:outline-none focus:ring-1 ${errors.service ? "border-red-500 focus:ring-red-400" : "border-gray-300 focus:ring-gray-400"
//                                         }`}
//                                 />
//                                 {errors.service && (
...
//                                 onChange={handleChange}
//                                 className={`border rounded-[10px] p-2 w-full bg-transparent focus:outline-none focus:ring-1 ${errors.message ? "border-red-500 focus:ring-red-400" : "border-gray-300 focus:ring-gray-400"
//                                     }`}
//                             ></textarea>
//                             {errors.message && (
